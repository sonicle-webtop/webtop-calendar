...
public class ApiCalendarAllOf   {
   ...
   * The calendar ID.
   **/
  public ApiCalendarAllOf id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ApiCalendarAllOf etag(String etag) {
    this.etag = etag;
    return this;
  }
   ...
   **/
  public ApiCalendarAllOf itemsETag(String itemsETag) {
   ...
   **/
  public ApiCalendarAllOf createdAt(String createdAt) {
   ...
   **/
  public ApiCalendarAllOf updatedAt(String updatedAt) {
  ...
  /**
   **/
  public ApiCalendarAllOf owner(ApiOwnerInfo owner) {
    this.owner = owner;
    return this;
  }
  ...
  /**
   **/
  public ApiCalendarAllOf permissions(ApiCalendarFolderPerms permissions) {
  ...
  public boolean equals(Object o) {
    ...
    ApiCalendarAllOf calendarAllOf = (ApiCalendarAllOf) o;
    return Objects.equals(this.id, calendarAllOf.id) &&
        Objects.equals(this.etag, calendarAllOf.etag) &&
        ...
        Objects.equals(this.permissions, calendarAllOf.permissions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, etag, itemsETag, createdAt, updatedAt, owner, isDefault, permissions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiCalendarAllOf {\n");
