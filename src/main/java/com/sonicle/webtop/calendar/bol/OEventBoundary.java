 ...
 * @author malbinola
 */
public class OEventBoundary implements EventBounds {
	protected final Boolean allDay;
	protected final DateTime start;
	protected final DateTime end;
	protected final String timezone;
	
	public OEventBoundary(Boolean allDay, DateTime start, DateTime end, String timezone) {
		this.allDay = Check.notNull(allDay, "allDay");
		this.start = Check.notNull(start, "start");
		this.end = Check.notNull(end, "end");
		this.timezone = Check.notEmpty(timezone, "timezone");
	}
