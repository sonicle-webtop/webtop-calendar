...
public class CalDav extends CaldavApi {
	...
	private ApiDavCalObject createCalObject(EventObject obj) {
		ApiDavCalObject ret = new ApiDavCalObject()
			.id(obj.getEventId())
	...
	private ApiDavCalObjectChanged createCalObjectChanged(EventObject calObject) {
	...
	private ApiDavCalObjectsChanges createCalObjectsChanges(DateTime lastRevisionTimestamp, Delta<EventObject> delta) {
