...
FOR EACH ROW
WHEN ((NOT COALESCE(NULLIF(current_setting('webtop.calendar.skip_calendars_history'::text, true), '')::boolean, false)))
...
FOR EACH ROW
WHEN ((NOT COALESCE(NULLIF(current_setting('webtop.calendar.skip_events_history'::text, true), '')::boolean, false)))
