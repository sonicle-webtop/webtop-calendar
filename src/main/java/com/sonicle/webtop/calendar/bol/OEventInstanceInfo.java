 ...
 * @author malbinola
 */
public class OEventInstanceInfo  {
	...
	public String getEventIdByInstance() {
		return eventIdByInstance;
	}
	
	public void setEventIdByInstance(String eventIdByInstance) {
		this.eventIdByInstance = eventIdByInstance;
	}
