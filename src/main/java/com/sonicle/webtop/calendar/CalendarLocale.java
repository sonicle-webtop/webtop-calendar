...
public class CalendarLocale {
	...
	public static final String TPL_EMAIL_INVITATION_VIEW = "tpl.email.invitation.view";
	...
	public static final String EMAIL_REMINDER_FOOTER_DISCLAIMER = "email.reminder.footer.disclaimer";
}
