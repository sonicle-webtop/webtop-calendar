...
@JsonTypeName("EventLkpInstance_allOf")
...
public class ApiEventLkpInstanceAllOf   {
   ...
   **/
  public ApiEventLkpInstanceAllOf iid(String iid) {
    this.iid = iid;
    return this;
  }
   ...
   **/
  public ApiEventLkpInstanceAllOf instanceType(String instanceType) {
   ...
   * The ID of the event.
   **/
  public ApiEventLkpInstanceAllOf originalEventId(String originalEventId) {
   ...
   **/
  public ApiEventLkpInstanceAllOf seriesEventId(String seriesEventId) {
   ...
   **/
  public ApiEventLkpInstanceAllOf etag(String etag) {
    this.etag = etag;
    return this;
  }
   ...
   **/
  public ApiEventLkpInstanceAllOf createdAt(String createdAt) {
   ...
   **/
  public ApiEventLkpInstanceAllOf updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ApiEventLkpInstanceAllOf eventLkpInstanceAllOf = (ApiEventLkpInstanceAllOf) o;
    return Objects.equals(this.iid, eventLkpInstanceAllOf.iid) &&
        Objects.equals(this.instanceType, eventLkpInstanceAllOf.instanceType) &&
        Objects.equals(this.originalEventId, eventLkpInstanceAllOf.originalEventId) &&
        Objects.equals(this.seriesEventId, eventLkpInstanceAllOf.seriesEventId) &&
        Objects.equals(this.etag, eventLkpInstanceAllOf.etag) &&
        Objects.equals(this.createdAt, eventLkpInstanceAllOf.createdAt) &&
        Objects.equals(this.updatedAt, eventLkpInstanceAllOf.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiEventLkpInstanceAllOf {\n");
